...
type: "post"
author: "Amber Thomas"
summary: A list of the data science courses I've taken, my ratings on them, and comments for future learners.
---
...
Anyone is welcome to use this list as they wish (**obviously**), but a few notes about my level of baseline knowledge before starting this journey. 
...
* **[Reporting with RMarkdown](https://www.datacamp.com/courses/reporting-with-r-markdown)** by [DataCamp](https://www.datacamp.com)
    ...
    + *Cost*: $29/month for unlimited access to DataCamp's entire course library
    + *Time to Complete*: 3 Hours 
    + *Comments*: I had no idea how simple RMarkdown could be before this course. Each of my [blog posts](/blog) and [projects](/portfolio) were written using RMarkdown, making report-writing simple. 
...
* **[Introduction to Machine Learning](https://www.datacamp.com/courses/introduction-to-machine-learning-with-r)** by [DataCamp](https://www.datacamp.com)
    ...
    + *Cost*: $29/month for unlimited access to DataCamp's entire course library
    + *Time to Complete*: 6 Hours 
    + *Comments*: This class gave me a good foundation of *how* to do some machine learning, but some of the theory behind it seemed to be missing. 
