...
<iframe seamless src="../img/articleImages/2017-01-07_genderMovieDialogue_img/RO_fig/index.html" width = "100%" height="500" id="iframe_container"></iframe>
...
knitr::include_graphics("../img/articleImages/2017-01-07_genderMovieDialogue_img/JB_Baloo.jpg")
```
...
```{r echo = FALSE, out.width = "80%", fig.align = "center"}
knitr::include_graphics("../img/articleImages/2017-01-07_genderMovieDialogue_img/Zootopia_Sloth.jpg")
```
...
<iframe seamless src="../img/articleImages/2017-01-07_genderMovieDialogue_img/RO_fig2/index.html" width = "100%" height="500" id="iframe_container"></iframe>
...
knitr::include_graphics("../img/articleImages/2017-01-07_genderMovieDialogue_img/RO_V1.jpg")
```
...
```{r echo = FALSE, out.width = "30%", fig.align = "center"}
knitr::include_graphics("../img/articleImages/2017-01-07_genderMovieDialogue_img/RO_V2.jpg")
```
...
```{r echo = FALSE, out.width = "30%", fig.align = "center"}
knitr::include_graphics("../img/articleImages/2017-01-07_genderMovieDialogue_img/RO_V3.jpg")
```
...
```{r echo = FALSE, out.width = "30%", fig.align = "center"}
knitr::include_graphics("../img/articleImages/2017-01-07_genderMovieDialogue_img/FinalDesign.jpg")
```
...
knitr::include_graphics("../img/articleImages/2017-01-07_genderMovieDialogue_img/ColorScheme1.png")
knitr::include_graphics("../img/articleImages/2017-01-07_genderMovieDialogue_img/ColorScheme2.png")
knitr::include_graphics("../img/articleImages/2017-01-07_genderMovieDialogue_img/ColorScheme3.png")
```
