...
knitr::include_graphics("img/articleImages/2016-12-19_creatingSite_img/frontmatter.png")
```
...
knitr::include_graphics("img/articleImages/2016-12-19_creatingSite_img/newrepo.png")
```
3. Name your repository your_username.github.io (see the below example for github username: animoplex)
```{r echo = FALSE, out.width = "90%", fig.align = "center"}
knitr::include_graphics("img/articleImages/2016-12-19_creatingSite_img/newrepo2.png")
```
...
knitr::include_graphics("img/articleImages/2016-12-19_creatingSite_img/clonerepo.png")
```
...
```{r echo = FALSE, out.width = "80%", fig.align = "center"}
knitr::include_graphics("img/articleImages/2016-12-19_creatingSite_img/clonerepo2.png")
```
...
```{r echo = FALSE, out.width = "80%", fig.align = "center"}
knitr::include_graphics("img/articleImages/2016-12-19_creatingSite_img/newsite.png")
```
...
```{r echo = FALSE, out.width = "60%", fig.align = "center"}
knitr::include_graphics("img/articleImages/2016-12-19_creatingSite_img/folders.png")
```
...
```{r echo = FALSE, out.width = "50%", fig.align = "center"}
knitr::include_graphics("img/articleImages/2016-12-19_creatingSite_img/createbranch.png")
```
...
```{r echo = FALSE, out.width = "90%", fig.align = "center"}
knitr::include_graphics("img/articleImages/2016-12-19_creatingSite_img/sourcesbranch.png")
```
```{r echo = FALSE, out.width = "90%", fig.align = "center"}
knitr::include_graphics("img/articleImages/2016-12-19_creatingSite_img/masterbranch.png")
```
...
knitr::include_graphics("img/articleImages/2016-12-19_creatingSite_img/navlinks.png")
```
...
```{r echo = FALSE, out.width = "90%", fig.align = "center"}
knitr::include_graphics("img/articleImages/2016-12-19_creatingSite_img/listfile.png")
```
...
```{r echo = FALSE, out.width = "60%", fig.align = "center"}
knitr::include_graphics("img/articleImages/2016-12-19_creatingSite_img/newblog.png")
```

Great! So let's use `serve_site()` to check out the page. 

```{r echo = FALSE, out.width = "80%", fig.align = "center"}
knitr::include_graphics("img/articleImages/2016-12-19_creatingSite_img/newblog2.png")
```
...
```{r echo = FALSE, out.width = "90%", fig.align = "center"}
knitr::include_graphics("img/articleImages/2016-12-19_creatingSite_img/missingimage.png")
```
...
```{r echo = FALSE, out.width = "90%", fig.align = "center"}
knitr::include_graphics("img/articleImages/2016-12-19_creatingSite_img/newblog3.png")
```
...
```{r echo = FALSE, out.width = "50%", fig.align = "center"}
knitr::include_graphics("img/articleImages/2016-12-19_creatingSite_img/pfrontmatter.png")
```

And our home page now contains this:
```{r echo = FALSE, out.width = "90%", fig.align = "center"}
knitr::include_graphics("img/articleImages/2016-12-19_creatingSite_img/pfrontmatter2.png")
```
