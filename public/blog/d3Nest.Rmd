...
```{r echo = FALSE}
ex1 <- read.csv("nestImg/Example1.csv", header = TRUE)
...
knitr::include_graphics("../nestImg/Example1.png")
```
...
knitr::include_graphics("../nestImg/Example1Structure.png")
```
...
library(lubridate)
ex2 <- read.csv("nestImg/Example2.csv", header = TRUE, stringsAsFactors = FALSE)
...
```{r echo = FALSE, out.width = "80%", fig.align = "center"}
knitr::include_graphics("../nestImg/Example2.png")
```
...
```{r echo = FALSE, out.width = "80%", fig.align = "center"}
knitr::include_graphics("../nestImg/Example2Structure.png")
```
...
```{r echo = FALSE, out.width = "80%", fig.align = "center"}
knitr::include_graphics("../nestImg/Example2Complete.png")
```
...
knitr::include_graphics("../nestImg/Example3Structure.png")
```
...
```{r echo = FALSE, out.width = "60%", fig.align = "center"}
knitr::include_graphics("../nestImg/Example3Complete.png")
```
...
```{r echo = FALSE, out.width = "60%", fig.align = "center"}
knitr::include_graphics("../nestImg/Example3Complete2.png")
```
...
```{r echo = FALSE}
ex4 <- read.csv("nestImg/Example4.csv", header = TRUE, stringsAsFactors = FALSE)
...
```{r echo = FALSE, out.width = "60%", fig.align = "center"}
knitr::include_graphics("../nestImg/Example4Structure.png")
```
...
```{r echo = FALSE, out.width = "60%", fig.align = "center"}
knitr::include_graphics("../nestImg/Example4.png")
```
...
```{r echo = FALSE, out.width = "60%", fig.align = "center"}
knitr::include_graphics("../nestImg/Example4Colors.png")
```
...
```{r echo = FALSE, out.width = "60%", fig.align = "center"}
knitr::include_graphics("../nestImg/Example4Dash.png")
```
...
```{r echo = FALSE, out.width = "60%", fig.align = "center"}
knitr::include_graphics("../nestImg/Example5Menu.png")
```
...
```{r echo = FALSE, out.width = "60%", fig.align = "center"}
knitr::include_graphics("../nestImg/Example5.png")
```
...
```{r echo = FALSE, out.width = "100%", fig.align = "center"}
knitr::include_graphics("../nestImg/Example6Examples.png")
```
...
```{r echo = FALSE, out.width = "60%", fig.align = "center"}
knitr::include_graphics("../nestImg/Example6Structure.png")
```
...
```{r echo = FALSE, out.width = "100%", fig.align = "center"}
knitr::include_graphics("../nestImg/Example6.png")
```
...
```{r echo = FALSE, out.width = "100%", fig.align = "center"}
knitr::include_graphics("../nestImg/Example7Menu.png")
```
...
```{r echo = FALSE, out.width = "100%", fig.align = "center"}
knitr::include_graphics("../nestImg/Example7Selected.png")
```
...
```{r echo = FALSE, out.width = "100%", fig.align = "center"}
knitr::include_graphics("../nestImg/Example7Selected2.png")
```
