...
knitr::include_graphics("../img/articleImages/2017-05-24_babyTiming_img/babyTimingVideo.gif")
```

```{r echo = FALSE, out.width = "50%"}
knitr::include_graphics("../img/articleImages/2017-05-24_babyTiming_img/babyTiming_img1.png")
knitr::include_graphics("../img/articleImages/2017-05-24_babyTiming_img/babyTiming_img2.png")
knitr::include_graphics("../img/articleImages/2017-05-24_babyTiming_img/babyTiming_img3.png")
knitr::include_graphics("../img/articleImages/2017-05-24_babyTiming_img/babyTiming_img4.png")
```
