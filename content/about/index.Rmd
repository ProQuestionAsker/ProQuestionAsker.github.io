...
### TL;DR
I'm a marine biologist and science communicator by training, but I'm taking all of the data analysis, statistics, and mathematical modeling skills I've learned (and continue to learn) and I'm now applying them to new problems. I'm currently a full-time "Maker" at [Polygraph](http://polygraph.cool/) and [The Pudding](https://pudding.cool/), but I'm always interested in chatting data/data viz! 
...
So, I decided to pursue the analytical side of my work and enter the world of data science.  I've been taking [lots of classes](https://proquestionasker.github.io/blog/ds_courses/), working on [lots of personal projects](../portfolio/), joining local Meetups, and finding work with the [Polygraph](http://polygraph.cool/)/[Pudding](http://pudding.cool) team. My day-to-day job now consists of data collection/scraping and analysis, story-writing, essay design, interactive data visualization creation, some front-end web development, and story-telling.  
